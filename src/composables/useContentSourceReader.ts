import { ComponentInternalInstance, inject, onBeforeMount, onServerPrefetch, onUpdated, Ref, ref, watch } from "vue"
...
export const useContentSourceReader = (currentInstance: ComponentInternalInstance | null, props: any, callback: CallbackFunction) => {
